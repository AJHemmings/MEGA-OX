...
export const PurchaseConfirmModal: React.FC<PurchaseConfirmModalProps> = ({
  ...
  // Move focus into dialog on mount so keyboard/screen reader users can interact
    ...
    >
      <Glass style={{ maxWidth: 340, width: '100%', padding: 0 }}>
        ...
        <div
          ...
          tabIndex={-1}
          style={{ padding: 24, fontFamily: tokens.font, outline: 'none' }}
        ...
        >
          ...
          <div style={{
            ...
            <span style={{ display: 'flex', alignItems: 'center', gap: 5, fontWeight: 800, color: tokens.text, fontSize: 14 }}>
              <Coin size={13} />
              {balanceAfter >= 0 ? balanceAfter.toLocaleString() : '—'}
            </span>
          </div>
